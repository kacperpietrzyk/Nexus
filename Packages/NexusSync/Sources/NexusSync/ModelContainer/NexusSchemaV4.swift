...
/// V4 schema: adds `externalSourceID` + `externalSourceMetadata` opt-in fields on `TaskItem`
/// for idempotent imports from external systems (Todoist/Linear/Obsidian/Circleback).
/// Lightweight additive migration from V3.
public enum NexusSchemaV4: VersionedSchema {
    ...
    /// Historical V4 `TaskItem` shape, frozen so V5-only fields do not
    /// retroactively alter the V4 checksum used by SwiftData migrations.
    @Model
