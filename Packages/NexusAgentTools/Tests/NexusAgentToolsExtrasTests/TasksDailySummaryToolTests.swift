...
struct TasksDailySummaryToolTests {
    ...
    func registration() {
        ...
        #expect(names.count == 81)
        #expect(Set(names).count == names.count)
        #expect(names.contains("export.item"))
        #expect(names.contains("export.bundle"))
        #expect(names.contains("stats.goals.get"))
        #expect(names.contains("stats.goals.update"))
        #expect(names.contains("stats.productivity"))
        #expect(names.contains("calendar.preferences.get"))
        #expect(names.contains("calendar.preferences.update"))
        ...
        #expect(names.contains("cycles.create"))
        #expect(names.contains("cycles.update"))
        #expect(names.contains("cycles.set_status"))
        #expect(names.contains("cycles.delete"))
        #expect(names.contains("projects.list"))
        #expect(names.contains("projects.update"))
        #expect(names.contains("projects.archive"))
        #expect(names.contains("projects.unarchive"))
        #expect(names.contains("projects.delete"))
        #expect(names.contains("projects.sections.list"))
        #expect(names.contains("projects.sections.update"))
        #expect(names.contains("projects.sections.delete"))
