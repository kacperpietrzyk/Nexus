...
@Suite struct SlotSchedulerTests {
    ...
    private func event(_ s: String, _ e: String) -> CalendarEvent {
        CalendarEvent(id: UUID().uuidString, title: "x", start: at(s), end: at(e), location: nil,
    ...
    @Test func freeSlotsAreGapsBetweenEventsMeetingMinimum() {
        ...
        let events = [event("2026-06-15T10:00:00Z", "2026-06-15T11:00:00Z"),
    ...
    @Test func slotFindsFirstFittingGapAcrossDays() {
        ...
        let slot = sched.slot(durationMinutes: 60, within: [day1, sched.calendar.date(byAdding: .day, value: 1, to: day1)!],
