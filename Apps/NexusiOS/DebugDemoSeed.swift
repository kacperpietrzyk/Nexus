...
///
/// Not compiled into Release. Drives the screenshot loop used while polishing
/// the Tasks/Notes surfaces — the empty "All clear" state can't reproduce the
/// data-dependent layout the populated list shows.
enum DebugDemoSeed {
    @MainActor
